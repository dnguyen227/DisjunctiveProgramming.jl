...
Planes, and solver-native Indicator constraints. Because the modeling layer is
kept separate from the encoding, we can switch between them on one model and
compare.
